...
function AboutTeamCard(){
    ...
    return(
        <div className="flex flex-col gap-10 p-10">
            <div className="flex flex-col gap-4 items-center text-center lg:w-1/2 md:w-4/5 w-full mx-auto">
            ...
            <div className="md:grid md:grid-cols-3 flex flex-col gap-5 ">
                {
                    about.map((item, index) => (
                        <div key={index} className="bg-gray-100 flex flex-col items-center p-4 rounded-lg shadow-md">
                        <div>
