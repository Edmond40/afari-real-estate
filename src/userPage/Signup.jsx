...
function SignUp() {
    ...
    return (
        <div className='my-5 md:my-0'>
            <div className="md:min-h-screen md:w-[90%] lg:w-[60%] mx-auto flex justify-center items-center">
                ...
                {success && <div className="text-green-600 text-sm mb-2">{success}
                        ...
                        <p className="text-center">Already have an account? <a href="/login" className="text-blue-500 hover:underline duration-300">Login</a></p>
                    </form>
                </div>
            </div>
        </div>
