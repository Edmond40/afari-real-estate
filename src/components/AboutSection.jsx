    ...
    return(
        <div className="relative h-[80vh] overflow-hidden">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center text-gray-50 gap-2">
                <h1 className="text-base lg:text-5xl md:text-4xl font-semibold text-yellow-400" data-aos="fade-right">About Afari Real Estate</h1>
                <p className="text-center md:text-base text-sm mx-2 md:mx-4" data-aos="fade-left">Your trusted partner in finding your dream property</p>
            </div>
        </div>
